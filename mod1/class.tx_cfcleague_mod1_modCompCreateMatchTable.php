...
//		t3lib_utility_Debug::debug((microtime(true)-$start), 'class.tx_cfcleague_mod1_modCompCreateMatchTable.php'); // TODO: remove me
	...
	private function showMatchTable($comp) {
  	global $LANG;
		...
		//t3lib_utility_Debug::debug($table, 'tx_cfcleague_mod1_modCompCreateMatchTable :: showCreateMatchTable'); // TODO: remove me
		return $content;
	}
...
//t3lib_utility_Debug::debug($table[1][0], 'class.tx_cfcleague_mod1_modCompCreateMatchTable.php'); // TODO: remove me
