...
//t3lib_utility_Debug::debug($teams, 'tx_cfcleague_mod1_modCompTeams'); // TODO: remove me
...
//		t3lib_utility_Debug::debug($tcaData, $uid.' - tx_cfcleague_mod1_modCompTeams'); // TODO: remove me
		
//		t3lib_utility_Debug::debug($data, 'tx_cfcleague_mod1_modCompTeams'); // TODO: remove me
	}
	/**
	...
	function showCurrentTeams(&$competition) {
		...
		$content .= $this->doc->table($arr); //, $this->getTableLayout()
		return $content;
//t3lib_utility_Debug::debug($arr, 'tx_cfcleague_mod1_modCompTeams'); // TODO: remove me
	}
